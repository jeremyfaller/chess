...
func TestMateIn2(t *testing.T) {
	tests := []struct {
		...
		{"6k1/1p1r1pp1/p1r3b1/3pPqB1/2pP4/Q1P4R/P3P2K/6R1 w - - 0 1"},
		...
		{"r1b1k2r/ppQ1q2n/2p2p2/P3p2p/N3P1pP/1B4P1/1PP2P2/3R1NK1 w - - 0 1"},
		...
		{"rn1qkb1r/4p2p/2p2nN1/p4p1Q/PpBP4/8/1P3PPP/R1B1K2R w - - 0 1"},
		...
		{"r3n1rk/q3NQ1p/p2pbP2/1p4p1/1P1pP1P1/3R4/P1P4P/3B2K1 w - - 0 1"},
		...
		{"4rr2/1p5R/3p1p2/p2Bp3/P2bPkP1/1P5R/1P2K3/8 w - - 0 1"},
		{"r4kr1/pbNn1q1p/1p6/2p2BPQ/5B2/8/P6P/b4RK1 w - - 0 1"},
		{"6rk/6pp/5p2/p7/P2Q1N2/4P1P1/2r2n1P/6K1 w - - 0 1"},
		...
		{"5b2/R4p1p/1r2kp2/1p2pN2/2r1P3/P1P3P1/1PK4P/3R4 w - - 0 1"},
		...
		{"5r1k/p2n1p1p/5P1N/1p1p4/2pP3P/8/PP4RK/8 w - - 0 1"},
		...
		{"8/8/2N1P3/1P6/4Q3/4b2K/4k3/4q3 w - - 0 1"},
		...
		{"r1b1k2r/1p2bppp/p3q3/1p2p1B1/8/3Q1N2/PPP2PPP/3R1RK1 w kq - 0 1"},
		{"rn2k2r/pp2b2p/2p1Q1p1/5B2/1q3B2/8/PPP3PP/3RR2K w kq - 0 1"},
		{"r1b1k2r/pp3ppp/2n1p3/6B1/2p1q3/Q7/PP2PPPP/3RKB1R w Kkq - 0 1"},
		{"5k1r/4npp1/p3p2p/3nP2P/3P3Q/3N4/qB2KPP1/2R5 w - - 0 1"},
		{"2r5/2R5/3npkpp/3bN3/p4PP1/4K3/P1B4P/8 w - - 0 1"},
		{"5r1r/1p6/p1p2p2/2P1bPpk/4R3/6PP/P2B2K1/3R4 w - - 0 1"},
		{"5qrk/5p1n/pp3p1Q/2pPp3/2P1P1rN/2P4R/P5P1/2B3K1 w - - 0 1"},
		{"3rk2r/p1qn1pp1/1p2pb1p/7P/2Pp4/B1P1QP2/P1B1KP2/3R3R w k - 0 1"},
		{"r3kb1r/q5pp/p1p1Bnn1/1p2Q3/8/2N2PBP/PPP5/2KRR3 w - - 0 1"},
		...
		{"r1bq1rkb/ppp2n1p/5n2/4p1NN/5pQ1/1BP5/PP3PPP/R1B1K2R w KQ - 0 1"},
		{"4r3/1b2r2p/p2p2k1/P1pP1R1N/3b4/1P1B3P/3n2P1/5R1K w - - 0 1"},
		{"2b3k1/1p5p/2p1n1pQ/3qB3/3P4/3B3P/r5P1/5RK1 w - - 0 1"},
		{"3rk2r/1pR2p2/b2BpPp1/p2p4/8/1P6/P4PPP/4R1K1 w - - 0 1"},
		{"4nr1k/1bq3pp/5p2/1p2pNQ1/3pP3/1B1P3R/1PP3PP/6K1 w - - 0 1"},
		{"r1bk1r2/pp1n2pp/3NQ3/1P6/8/2n2PB1/q1B3PP/3R1RK1 w - - 0 1"},
		{"1rb2k2/pp3ppQ/7q/2p1n1N1/2p5/2N5/P3BP1P/K2R4 w - - 0 1"},
		...
		{"2r1kb1r/p2b1ppp/3p4/Q2Np1B1/4P2P/8/PP4P1/4KB1n w k - 0 1"},
		{"r2q1bk1/5n1p/2p3pP/p7/3Br3/1P3PQR/P5P1/2KR4 w - - 0 1"},
		{"4Q3/r4ppk/3p3p/4pPbB/2P1P3/1q5P/6P1/3R3K w - - 0 1"},
		{"rn5r/p4pp1/3n3p/qB1k4/3P4/4P3/PP2NPPP/R4K1R w - - 0 1"},
		{"5R2/6k1/3K4/p6r/1p1NB3/1P4r1/8/8 w - - 0 1"},
		...
		{"r2q1k1r/3bnp2/p1n1pNp1/3pP1Qp/Pp1P4/2PB4/5PPP/R1B2RK1 w - - 0 1"},
		{"6rk/1r2pR1p/3pP1pB/2p1p3/P6Q/P1q3P1/7P/5BK1 w - - 0 1"},
		{"1r2Rr2/3P1p1k/5Rpp/qp6/2pQ4/7P/5PPK/8 w - - 0 1"},
		{"r4rk1/5Rbp/p1qN2p1/P1n1P3/8/1Q3N1P/5PP1/5RK1 w - - 0 1"},
		{"7R/3r4/8/3pkp1p/5N1P/b3PK2/5P2/8 w - - 0 1"},
		{"8/1R3p2/3rk2p/p2p2p1/P2P2P1/3B1PN1/5K1P/r7 w - - 0 1"},
		...
		{"5r2/7p/3R4/p3pk2/1p2N2p/1P2BP2/6PK/4r3 w - - 0 1"},
		...
		{"8/k1p1q3/Pp5Q/4p3/2P1P2p/3P4/4K3/8 w - - 0 1"},
		{"8/p4q2/6k1/1p3rP1/3Q4/8/PPP5/K6R w - - 0 1"},
		{"r7/4k1Pp/2n1p2P/q2pp1N1/1p4P1/1P6/P4R2/1K1R4 w - - 0 1"},
		{"2Q5/1p3p2/3b1k1p/3Pp3/4B1R1/4q1P1/r4PK1/8 w - - 0 1"},
		{"8/5Qpk/p1R4p/P2p4/6P1/2rq4/5PPK/8 w - - 0 1"},
		{"3n1k2/5p2/2p1bb2/1p2pN1q/1P2P3/2P3Q1/5PB1/3R2K1 w - - 0 1"},
		{"rnR5/p3p1kp/4p1pn/bpP5/5BP1/5N1P/2P2P2/2K5 w - - 0 1"},
		{"6rk/6p1/4R2p/p2pP2b/5Q2/2P2PB1/1q4PK/8 w - - 0 1"},
		...
		{"8/3R3p/2b4k/p1p1B1p1/2n2PB1/3p1P2/P7/6K1 w - - 0 1"},
		{"k2r4/ppRn2p1/6p1/1P3p2/3p1B2/6P1/P4PBP/4n1K1 w - - 0 1"},
		{"4rk2/1bq2p1Q/3p1bp1/1p1n2N1/4PB2/2Pp3P/1P1N4/5RK1 w - - 0 1"},
		{"8/R7/pp1b2kp/1b1B1p2/5P1P/5KP1/P7/8 w - - 0 1"},
		{"6k1/p2p2p1/8/3np1N1/1P5R/3q2P1/5RKP/8 w - - 0 1"},
		{"n3r1k1/Q4R1p/p5pb/1p2p1N1/1q2P3/1P4PB/2P3KP/8 w - - 0 1"},
		{"2r5/2k4p/1p2pp2/1P2qp2/8/Q5P1/4PP1P/R5K1 w - - 0 1"},
		{"6k1/4q1b1/p1p1p1Q1/1r4N1/4p3/1P5R/5P2/7K w - - 0 1"},
	...
	for i, test := range tests {
		...
		d += e.Duration()
		t.Logf("%d/%d %d %s\n", i, len(tests), e.positions, e.TimeString())
